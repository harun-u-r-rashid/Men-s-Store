...
def uniqueTrasactionGenerator(size = 10, chars = string.ascii_uppercase + string.digits):
...
def sslcommerz_payment_gateway(request, id, user_id, grand_total):
    gateway_auth_details = PaymentGateway.objects.all().first()
    ...
    post_body['success_url'] = 'http://127.0.0.1:8000/appOrder/orderDetails/'
    post_body['fail_url'] = 'http://127.0.0.1:8000/appOrder/failedOrder/'
